...
private Context context;
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        TextDrawable drawable = TextDrawable.builder().buildRound(""+listData.get(position).getQantity(),
                Color.RED);
       ...
       // NumberFormat fmt = NumberFormat.getCurrencyInstance(locale);
        int price = (Integer.parseInt(listData.get(position).getPrice()))*
                (Integer.parseInt(listData.get(position).getQantity()));
       // holder.txt_price.setText(fmt.format(price));
        holder.txt_price.setText(price+" б.р.");
